...
var isGreyhawkPresent = function(turnorder)
{
  ...
  return _.find(turnorder, function(e,i) {if (parseInt(e.id) === -1 && parseInt(e.pr) === -99 && e.custom.match(/Greyhawk Setup/)){return true;}});
};
...
var updateGreyhawkMarker = function(turnorder)
{
  ...
  if (!!(tracker = _.find(turnorder, function(e,i) {if (parseInt(e.id) === -1 && parseInt(e.pr) === -99 && e.custom.match(/Greyhawk Setup/)){trackerpos = i;return true;}})))
  {
